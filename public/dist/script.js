...
window.addEventListener("load", (event) => {
    ...
    const iconQuestion = document.getElementById('icon-question');
    const btnRoll = document.getElementById('btn-roll');
    const textRoll = document.querySelector('.text-roll');
    const btnHold = document.getElementById('btn-hold');
    const textHold = document.querySelector('.text-hold');
    const roundScorePlayer1 = document.querySelector('.round-score-player-1');
    const roundScorePlayer2 = document.querySelector('.round-score-player-2');
    const globalScorePlayer1 = document.querySelector('.player-1-global-score');
    const globalScorePlayer2 = document.querySelector('.player-2-global-score');
    const player1 = document.querySelector('.player-1');
    const player2 = document.querySelector('.player-2');
    const player1Text = document.querySelector('.player-1-text');
    const player2Text = document.querySelector('.player-2-text');
